...
oss_end_point= 'oss-cn-shanghai-internal.aliyuncs.com'#访问对象存储的endpoint
oss_bucket_name='tokisaki-oss'#可以使用的对象存储桶名称
...
def list():
    try:
        ...
        if request.method=="POST":
            ...
            if path:
                path = "drives/{}/root:/pubilc/{}:/children".format(drive, path)
            else:
                path = "me/drive/root:/public:/children"
            url = base_url + path
